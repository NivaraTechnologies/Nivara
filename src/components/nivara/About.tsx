      ...
      <section className="px-4 pb-24 text-center">
        ...
        >
          ...
          <Link
            to="/"
            hash="inquire"
            className="mt-6 inline-block rounded-full bg-primary px-8 py-3 font-medium text-primary-foreground transition-transform hover:scale-105 hover:brightness-110"
          >
            Let's talk
          </Link>
        </motion.div>
