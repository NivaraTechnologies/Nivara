  ...
  return (
    <section id="about" className="px-4 py-20">
      ...
      >
        ...
        <h2 className="mt-6 font-display text-4xl font-extrabold tracking-[-0.04em] md:text-5xl">
          We're <span className="text-brand-navy">Nivara Technologies</span>
        </h2>
        <p className="mt-5 text-lg text-muted-foreground">
          We're a web development studio that designs and builds premium
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        transition={{ duration: 0.6 }}
        className="mx-auto mt-12 flex max-w-4xl flex-col items-center gap-8 rounded-[24px] border border-border bg-card p-8 md:flex-row md:p-10"
      >
        <img
          src="/team/sai-nithin.jpeg"
          alt="Sai Nithin, Founder of Nivara Technologies"
      ...
      >
        <h3 className="text-center font-display text-2xl font-extrabold tracking-[-0.03em] md:text-3xl">
          What we stand for
        </h3>
        <div className="mt-8 grid gap-5 md:grid-cols-3">
          {values.map((value, i) => (
            <motion.div
              ...
              className="rounded-[20px] border border-border bg-card p-6"
            >
              <h4 className="font-display text-lg font-bold">{value.title}</h4>
              <p className="mt-2 text-sm text-muted-foreground">
                {value.description}
              </p>
            </motion.div>
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        transition={{ duration: 0.6 }}
        className="mx-auto mt-16 flex max-w-5xl flex-wrap items-center justify-center gap-3 rounded-[20px] border border-border bg-card p-6"
      >
        {stack.map((tech) => (
          <span
            key={tech}
